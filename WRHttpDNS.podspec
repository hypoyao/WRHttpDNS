#
#  Be sure to run `pod spec lint WRHttpDNS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "WRHttpDNS"
  s.version      = "1.1"
  s.summary      = "A simple httpDNS framework, support http and https"
...
3. Provide GoogleDNS service default, you can add other custom DNS service easily.
  ...
  # Or just: s.author    = "hypoyao"
  # s.authors            = { "hypoyao" => "hypoyao@qq.com" }
  # s.social_media_url   = "http://twitter.com/hypoyao"
